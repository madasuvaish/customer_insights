...
import nltk
nltk.download('punkt')
import wordcloud  ##C:/Users/USER/OneDrive/Desktop/Customer-Analytics-and-Behaviour-Prediction-main/DATASET

data = pd.read_excel('C:/Users/USER/OneDrive/Desktop/Customer-Analytics-and-Behaviour-Prediction-main/DATASET/final.xlsx', dtype={'StockCode':str})
#print(data.head(3))
#print(data.shape)
